...
from main.views import product_list, create_product, show_xml, show_json, show_xml_by_id, show_json_by_id, registrasi, login_user, logout_user, product_management, add_product, subtract_product, delete_product, get_product_json, add_product_ajax
